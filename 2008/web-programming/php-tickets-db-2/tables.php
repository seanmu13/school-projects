<?php
	$db = mysql_connect("localhost","MyDatabase","loewe.heder");
	mysql_select_db("MyDatabase") or die(mysql_error());

	echo "<html><head><link rel = 'stylesheet' type = 'text/css' href = 'style.css' /><title>Tables</title></head><body><center>";
	$query = "SELECT * FROM tickets";
	show_table($query,"tickets");
	$query = "SELECT * FROM users";
	show_table($query,"users");
